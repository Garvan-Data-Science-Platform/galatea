...
SECRET_KEY = 'django-insecure--lrn#n2yg#-ll(s#^dc+%k4cx020(k@6op)e%3*pehmn48434t'
...
CRONJOBS = [('*/5 * * * *', 'api.cron.shutdown_worker', '>> ' + os.path.join(BASE_DIR, 'debug.log'))]
...
CRONTAB_COMMAND_PREFIX = f"FLOWER_CONN={FLOWER_CONN} DJANGO_SETTINGS_MODULE=galatea.production_settings"
